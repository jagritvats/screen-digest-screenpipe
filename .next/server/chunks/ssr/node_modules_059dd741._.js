...
"[project]/node_modules/@screenpipe/js/dist/inbox-server.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@screenpipe/js/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
var S = (n, e = "")=>Object.keys(n).reduce((t, r)=>{
        let s = e.length ? e + "." : "";
...
var y = k(), f = class {
    ...
    async getStorePath() {
        let e = process.platform, t = __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["default"].homedir(), r;
        switch(e){
            case "darwin":
                r = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(t, "Library", "Application Support", "screenpipe");
                break;
            case "linux":
                let o = process.env.XDG_DATA_HOME || __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(t, ".local", "share");
                r = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(o, "screenpipe");
                break;
            case "win32":
                r = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.env.LOCALAPPDATA || __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(t, "AppData", "Local"), "screenpipe");
                break;
            default:
                throw new Error(`unsupported platform: ${e}`);
        }
        let s = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(r, "profiles.bin"), a = "default";
        try {
            let o = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(s), u = JSON.parse(o.toString());
            u.activeProfile && (a = u.activeProfile);
        } catch  {}
        return a === "default" ? __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(r, "store.bin") : __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(r, `store-${a}.bin`);
    }
    async init() {
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        ...
        try {
            ...
            let e = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(this.storePath), t = JSON.parse(e.toString());
            this.settings = {
                ...y,
                ...P(t)
            }, this.initialized = !0;
    ...
    async save() {
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(this.storePath, JSON.stringify(e, null, 2));
    }
    async get(e) {
    ...
    async getCustomSetting(e, t) {
        return this.initialized || await this.init(), this.settings.customSettings?.[e]?.[t];
    }
    ...
    async getNamespaceSettings(e) {
        return this.initialized || await this.init(), this.settings.customSettings?.[e];
    }
...
async function J() {
    return new Promise((n, e)=>{
        let t = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$net__$5b$external$5d$__$28$net$2c$__cjs$29$__["createServer"])();
...
var g = class {
    ...
    actionServerProcess;
    async send(e) {
        this.actionServerPort || (this.actionServerPort = await J(), this.actionServerProcess = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["fork"])("./inbox-server.js", [
...
var w = class {
    ...
    async info(e) {
        try {
            let r = await fetch(`http://localhost:3030/pipes/info/${e}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                }
...
var x = class {
    ...
    async sendInputControl(e) {
        try {
            let t = await fetch(`${this.baseUrl}/experimental/operator/pixel`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    async click(e) {
        ...
        }, r = await fetch(`${this.baseUrl}/experimental/operator/click`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to click element: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to click element (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
        if (console.log("debug: click response data:", JSON.stringify(s, null, 2)), !s.success) throw new Error(`click operation failed: ${s.error || "unknown error"}`);
    ...
    async fill(e) {
        ...
        let r = await fetch(`${this.baseUrl}/experimental/operator/type`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to type text: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to type text (status ${r.status}): ${a || r.statusText}`);
            }
        }
    ...
    getByRole(e, t) {
        return this.locator({
            ...
            window: t?.window,
            role: e,
            useBackgroundApps: t?.useBackgroundApps,
            activateApp: t?.activateApp
        });
    }
    getById(e, t) {
        return this.locator({
    ...
    async getText(e) {
        ...
        }, r = await fetch(`${this.baseUrl}/experimental/operator/get_text`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to get text: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to get text (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
        if (console.log("debug: text response data:", JSON.stringify(s, null, 2)), !s.success) throw new Error(`get_text operation failed: ${s.error || "unknown error"}`);
        return c(s);
    }
    async getInteractableElements(e) {
        ...
        }, r = await fetch(`${this.baseUrl}/experimental/operator/list-interactable-elements`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to get interactable elements: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to get interactable elements (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
    ...
    async clickByIndex(e) {
        let t = await fetch(`${this.baseUrl}/experimental/operator/click-by-index`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!t.ok) {
            ...
            try {
                let a = JSON.parse(s);
                throw new Error(`failed to click element by index: ${a.error || t.statusText}`);
            } catch  {
                throw new Error(`failed to click element by index (status ${t.status}): ${s || t.statusText}`);
            }
        }
        let r = await t.json();
        if (!r.success) throw new Error(`click operation failed: ${r.message || "unknown error"}`);
        return r.success;
    }
    async typeByIndex(e, t) {
        let r = await fetch(`${this.baseUrl}/experimental/operator/type-by-index`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to type text into element by index: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to type text into element by index (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
        if (!s.success) throw new Error(`type operation failed: ${s.message || "unknown error"}`);
        return s.success;
    }
    async pressKey(e) {
        let t = {
            ...
            use_background_apps: e.useBackgroundApps,
            activate_app: e.activateApp !== false
        }, r = await fetch(`${this.baseUrl}/experimental/operator/press-key`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to press key: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to press key (status ${r.status}): ${a || r.statusText}`);
            }
        }
        return (await r.json()).success;
    }
    async pressKeyByIndex(e, t) {
        let r = await fetch(`${this.baseUrl}/experimental/operator/press-key-by-index`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to press key on element by index: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to press key on element by index (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
        if (!s.success) throw new Error(`press key operation failed: ${s.message || "unknown error"}`);
        return s.success;
    }
    async openApplication(e) {
        let t = await fetch(`${this.baseUrl}/experimental/operator/open-application`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!t.ok) {
            ...
            try {
                let a = JSON.parse(s);
                throw new Error(`failed to open application: ${a.error || t.statusText}`);
            } catch  {
                throw new Error(`failed to open application (status ${t.status}): ${s || t.statusText}`);
            }
        }
        let r = await t.json();
        if (!r.success) throw new Error(`open application operation failed: ${r.message || "unknown error"}`);
        return r.success;
    }
    async openUrl(e, t) {
        let r = await fetch(`${this.baseUrl}/experimental/operator/open-url`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to open url: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to open url (status ${r.status}): ${a || r.statusText}`);
            }
        }
        let s = await r.json();
        if (!s.success) throw new Error(`open url operation failed: ${s.message || "unknown error"}`);
        return s.success;
    }
    async scroll(e) {
        let t = {
            ...
            use_background_apps: e.useBackgroundApps,
            activate_app: e.activateApp !== false
        }, r = await fetch(`${this.baseUrl}/experimental/operator/scroll`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to scroll element: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to scroll element (status ${r.status}): ${a || r.statusText}`);
            }
        }
        return (await r.json()).success;
    }
    ...
    async all(e, t) {
        let r = await fetch(`${this.baseUrl}/experimental/operator`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!r.ok) {
            ...
            try {
                let o = JSON.parse(a);
                throw new Error(`failed to find elements: ${o.error || r.statusText}`);
            } catch  {
                throw new Error(`failed to find elements (status ${r.status}): ${a || r.statusText}`);
            }
        }
        return (await r.json()).data;
    }
    async click() {
        let e = await fetch(`${this.baseUrl}/experimental/operator/click`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!e.ok) {
            ...
            try {
                let s = JSON.parse(r);
                throw new Error(`failed to click element: ${s.error || e.statusText}`);
            } catch  {
                throw new Error(`failed to click element (status ${e.status}): ${r || e.statusText}`);
            }
        }
        let t = await e.json();
        if (console.log("debug: click response data:", JSON.stringify(t, null, 2)), !t.success) throw new Error(`click operation failed: ${t.error || "unknown error"}`);
    ...
    async fill(e) {
        let t = await fetch(`${this.baseUrl}/experimental/operator/type`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!t.ok) {
            ...
            try {
                let a = JSON.parse(s);
                throw new Error(`failed to type text: ${a.error || t.statusText}`);
            } catch  {
                throw new Error(`failed to type text (status ${t.status}): ${s || t.statusText}`);
            }
        }
        return (await t.json()).success;
    }
    ...
    async pressKey(e) {
        let t = await fetch(`${this.baseUrl}/experimental/operator/press-key`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!t.ok) {
            ...
            try {
                let a = JSON.parse(s);
                throw new Error(`failed to press key: ${a.error || t.statusText}`);
            } catch  {
                throw new Error(`failed to press key (status ${t.status}): ${s || t.statusText}`);
            }
        }
        return (await t.json()).success;
    }
    async scroll(e, t) {
        let r = await fetch(`${this.baseUrl}/experimental/operator/scroll`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
O({
    init: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].init.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]),
    identify: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].identify.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]),
    capture: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].capture.bind(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])
});
var E = class {
    ...
    async queryScreenpipe(e) {
        ...
        let r = `http://localhost:3030/search?${t}`;
        try {
            let s = await fetch(r);
            if (!s.ok) {
...
"[project]/node_modules/micromark/node_modules/debug/node_modules/ms/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ function setup(env) {
    ...
    createDebug.humanize = __turbopack_context__.r("[project]/node_modules/micromark/node_modules/debug/node_modules/ms/index.js [app-ssr] (ecmascript)");
...
//# sourceMappingURL=node_modules_059dd741._.js.map